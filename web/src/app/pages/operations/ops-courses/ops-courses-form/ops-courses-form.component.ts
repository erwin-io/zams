...
@Component({
  selector: 'app-ops-courses-form',
  templateUrl: './ops-courses-form.component.html',
  styleUrls: ['./ops-courses-form.component.scss']
})
export class OpsCourseFormComponent {
  courseCode;
  isNew = false;
  error;
  isLoading = true;
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<OpsCourseFormComponent>) {
