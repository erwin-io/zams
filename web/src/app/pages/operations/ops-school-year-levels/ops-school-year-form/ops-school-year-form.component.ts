...
@Component({
  selector: 'app-ops-school-year-form',
  templateUrl: './ops-school-year-form.component.html',
  styleUrls: ['./ops-school-year-form.component.scss']
})
export class OpsSchoolYearLevelFormComponent {
  schoolYearLevelCode;
  isNew = false;
  error;
  isLoading = true;
