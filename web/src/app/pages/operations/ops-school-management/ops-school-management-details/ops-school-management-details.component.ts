...
@Component({
  ...
  templateUrl: './ops-school-management-details.component.html',
  styleUrls: ['./ops-school-management-details.component.scss'],
  host: {
    class: "page-component"
  }
})
export class OpsSchoolManagementDetailsComponent {
  schoolCode;
  isNew = false;
  isReadOnly = true;
  ...
  constructor(
    ...
    this.currentProfile = this.storageService.getLoginProfile();
    ...
    dialogRef.componentInstance.conFirm.subscribe(async (data: any) => {
      ...
      try {
        ...
        if(this.isNew) {
          params = {
            ...params,
            registeredByUserId : this.currentProfile.user.userId
          }
          res = await this.schoolsService.create(params).toPromise();
        } else {
          params = {
            ...params,
            updatedByUserId: this.currentProfile.user.userId
          }
