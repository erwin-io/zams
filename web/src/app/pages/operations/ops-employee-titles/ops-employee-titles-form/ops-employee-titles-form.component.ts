...
@Component({
  selector: 'app-ops-employee-titles-form',
  templateUrl: './ops-employee-titles-form.component.html',
  styleUrls: ['./ops-employee-titles-form.component.scss']
})
export class OpsEmployeeTitleFormComponent {
  employeeTitleCode;
  isNew = false;
  error;
  isLoading = true;
